...
import { WindowCommands, ErrorCommands } from '@/constants'
import type { WindowRequest } from '@/types/requestTypes'
import type { InitMessage, ErrorResponse } from '@/types/responseTypes'

// Set a default request to display to the user
